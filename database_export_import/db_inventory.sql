...
--
-- Host: 127.0.0.1
-- Generation Time: 07 Nov 2017 pada 07.14
-- Versi Server: 5.6.26
-- PHP Version: 5.6.12
...
CREATE TABLE IF NOT EXISTS `td_peminjaman_barang` (
...
('PJ201711007001', 'PJ201711007', 'BRG0005', '2017-11-05 00:06:44', '1'),
('PJ201711007002', 'PJ201711007', 'BRG0006', '2017-11-05 00:06:44', '1'),
('PJ201711008001', 'PJ201711008', 'INV2017002', '2017-11-06 20:20:54', '1'),
('PJ201711008002', 'PJ201711008', 'INV2017001', '2017-11-06 20:20:54', '1'),
('PJ201711008003', 'PJ201711008', 'BRG0009', '2017-11-06 20:20:54', '1'),
('PJ201711009001', 'PJ201711009', 'BRG0001', '2017-11-06 20:26:50', '1'),
('PJ201711009002', 'PJ201711009', 'BRG0002', '2017-11-06 20:26:50', '1'),
('PJ201711010001', 'PJ201711010', 'BRG0008', '2017-11-06 20:54:55', '1'),
('PJ201711011001', 'PJ201711011', 'INV2017006', '2017-11-07 08:16:20', '1'),
('PJ201711011002', 'PJ201711011', 'INV2017005', '2017-11-07 08:16:20', '1');

--
-- Trigger `td_peminjaman_barang`
--
DELIMITER $$
CREATE TRIGGER `ubah_peminjaman_stat_parent` AFTER UPDATE ON `td_peminjaman_barang`
 FOR EACH ROW BEGIN 
...
CREATE TABLE IF NOT EXISTS `tm_barang_inventaris` (
...
('BRG0001', 'J001', '1', 'Buku Aladin', '2017-10-30', '2017-10-30 09:00:00', '1'),
('BRG0002', 'J002', '1', 'Komputer Zyrex', '2017-10-30', '2017-10-30 09:00:00', '1'),
...
CREATE TABLE IF NOT EXISTS `tm_peminjaman` (
...
('PJ201711007', '1', '2017-11-05 00:06:44', 'S010', '2017-11-09 17:06:00', '1'),
('PJ201711008', '4', '2017-11-06 20:20:54', 'S001', '2017-11-11 13:20:00', '1'),
('PJ201711009', '4', '2017-11-06 20:26:50', 'S004', '2017-11-12 13:26:00', '1'),
('PJ201711010', '4', '2017-11-06 20:43:58', 'S002', '2017-11-13 13:49:00', '1'),
('PJ201711011', '4', '2017-11-07 08:02:49', 'S012', '2017-11-10 20:16:00', '1');
...
CREATE TABLE IF NOT EXISTS `tm_pengembalian` (
...
--
DELIMITER $$
CREATE TRIGGER `update_peminjaman_barang` AFTER INSERT ON `tm_pengembalian`
 FOR EACH ROW BEGIN 
...
(3, 'admin', '$2y$10$VY4nK9cupZLOmBZ4xM1RJ.5vungkyUlfz.Nu4TtMue3YdX9nCTi.2', 'ad', '1', '2017-11-04 14:14:23', '2017-11-04 14:14:23', 'NdZLnyXuCj0J9MwbWNau73m76fDJFMSAiuBWL69pitUmzVrfMpNVZQmz3XP0'),
(4, 'aris', '$2y$10$JvjH5yNK/1uvvN9AKIIZZ.iV9rKscFY98V3mcAdBq7Eu/G.JMJsIa', 'su', '1', '2017-11-05 08:52:35', '2017-11-05 08:40:57', 'dhpY9S7x4dZMNdjgsKtgA2iOBRMul6P10mIDzgW2c3CV7a5x1vqjQF3lWxiX');
...
CREATE TABLE IF NOT EXISTS `tr_jenis_barang` (
